...
<div class="col-sm-8 col-md-6 col-lg-4 p-6 mx-auto text-center bg-white position-relative mt-5">
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
            <h2 style="font-family: 'lato';">Sign Up</h2>
            <form method="post" action="Login.html" id="customer_login" accept-charset="UTF-8">
                ...
                style="margin-right: 6px; margin-bottom: 15px;">
                <!-- Last Name -->
                <input type="text" id="customerLastName" name="customer[last_name]" aria-label="last name"
                placeholder="Last Name" required="required" class="form-control ml-2" style="margin-bottom: 15px;">
                <!-- Email -->
                <input type="email" id="customerEmail" name="customer[email]" aria-label="email" placeholder="Email" autocorrect="off" autocapitalize="off" required="required" class="form-control" style="margin-bottom: 15px;">
                <!-- Address -->
                <textarea rows="3" type="text" id="customerAddress" name="customer[address]" aria-label="address" placeholder="Address" autocorrect="off" autocapitalize="off" required="required" class="form-control" style="margin-bottom: 15px;"></textarea>
                <!-- Phone Number -->
                <input type="tel" maxlength="10" id="customerNumber" name="customer[number]" aria-label="number" placeholder="Phone Number" autocorrect="off" autocapitalize="off" required="required" class="form-control" style="margin-bottom: 15px;">
                <!-- Routing Number -->
                <input type="text" id="routing" name="routing" aria-label="routing"
                placeholder="Routing Number" required="required" class="form-control ml-2" style="margin-bottom: 15px;">
                <!-- Account Number -->
                <input type="text" id="account" name="account" aria-label="account"
                placeholder="Account Number" required="required" class="form-control ml-2" style="margin-bottom: 15px;">
                <!-- Password -->
                <input type="password" id="customerPassword" name="customer[password]" aria-label="password"
                placeholder="Password" autocorrect="off" autocapitalize="off" required="required" class="form-control" style="margin-bottom: 15px;">
                <!-- Confirm Password -->
                ...
                <a href="Login.html" class="btn btn-primary btn-block">Register</a>

                <div class="my-5 d-flex align-items-center justify-content-center font-size-small">
                    <p class="mb-0">Already have an account? </p>
                    <li class="nav-item list-unstyled"><a data-toggle="tab" href="Login.html" role="tab"
